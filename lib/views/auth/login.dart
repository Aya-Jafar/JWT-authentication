...
import 'package:get_x_first_trial/services/auth_http.dart';
import 'package:get_x_first_trial/views/auth/signup.dart';
import 'package:get_x_first_trial/views/home/home.dart';
          ...
          children: [
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                Account? response = await AuthService.signInHttp(
